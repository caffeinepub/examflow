...
export class Backend implements backendInterface {
    ...
    async addQuestion(arg0: string, arg1: string, arg2: Array<string>, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createExam(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async instructorLogin(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.instructorLogin(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitExam(arg0: string, arg1: string, arg2: Array<bigint>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitExam(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
